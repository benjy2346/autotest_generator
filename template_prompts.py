...
,
'''我们的雷达产品以太网配置如下，
采用UDP数据传输，消息ID 0x11E payload长度8bytes,
以20ms周期性发送,消息包含起始位0的8bit CRC校验，
取值范围0-255;起始位8的4bit 消息计数，取值范围0-14;
起始位29的1bit 车速校验及初始状态，取值范围0-1;起始位32的13bit 车速信息，
取值范围0-360（无效值1901-1FFF）''']
